...
*** Backup
For the moment you have to declare which directories have to be backed up
in the *install.yml* for the backup role.
#+BEGIN_SRC yaml
- role: backup
  backuped_directories: '~/dev ~/.mail/ ~/Documents/'
#+END_SRC
